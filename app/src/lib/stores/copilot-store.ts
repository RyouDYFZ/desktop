...
export class CopilotStore {
   ...
   * @param model Optional model ID to use. If null, falls back to 'gpt-5-mini'.
  ...
  /**
   * Lists the available Copilot models from the SDK.
   *
   * Creates a temporary client, fetches the model list, and stops the client.
